<x-layout>
    ...
    <div class="mx-4">
            ...
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <div>
                    ...
                    <div class="text-lg space-y-6">
                        ...
                        <a href="{{$listing->url}}" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80"><i class="fa-solid fa-globe"></i> Visit
                            Website</a>
                    </div>
                </div>
            </div>
        ...
        <div class="flex bg-gray-50 border border-gray-200 rounded p-6">
            <a class=" mr-5" href="/listings/{{$listing->id}}/edit">
